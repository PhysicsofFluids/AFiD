...
ACLOCAL = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/missing autoconf
AUTOHEADER = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/missing autoheader
AUTOMAKE = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/missing automake-1.13
AWK = gawk
BLAS_LIBS = -L/opt/intel/composer_xe_2015.0.090/mkl/lib/intel64 -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread
CC = gcc
...
EXEEXT = 
FC = skin mpiifort
FCFLAGS = -O2 -r8 -fopenmp -I /hpc/sw/hdf5-1.8.14-intel-impi-par/include
FCFLAGS_F = 
FCFLAGS_f90 = 
FCLIBS =  -L/hpc/sw/papi-5.1.1/lib -L/hpc/sw/scorep-1.4-intel-impi-par/lib -L/hpc/sw/hdf5-1.8.14-intel-impi-par/lib -L/hpc/sw/fftw3avx-3.3.3-intel-impi/lib -L/opt/intel/composer_xe_2015.0.090/mkl/lib/intel64 -L/opt/intel/composer_xe_2015.0.090/compiler/lib/intel64 -L/hpc/sw/scalasca-2.2-intel-impi-par/lib
FC_DEFINE = -D
FC_MODINC = -I
FFTW3_LIBS =  -lfftw3_omp -lfftw3
GREP = /bin/grep
H5FC = /hpc/sw/hdf5-1.8.14-intel-impi-par/bin/h5pfc
...
LAPACK_LIBS = 
LDFLAGS =  -L /hpc/sw/hdf5-1.8.14-intel-impi-par/lib   -L/hpc/sw/hdf5-1.8.14-intel-impi-par/lib
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/missing makeinfo
MKDIR_P = /bin/mkdir -p
MPIFC = skin mpiifort
OBJEXT = o
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/donners/Tickets/24142/neighbor_alltoallw
abs_srcdir = /home/donners/Tickets/24142/neighbor_alltoallw
abs_top_builddir = /home/donners/Tickets/24142/neighbor_alltoallw
abs_top_srcdir = /home/donners/Tickets/24142/neighbor_alltoallw
ac_ct_CC = gcc
ac_ct_FC = 
ac_ct_MPIFC = 
ac_empty = 
...
install_sh = ${SHELL} /home/donners/Tickets/24142/neighbor_alltoallw/install-sh
...
boutnp_LDADD = $(FFTW3_LIBS) $(LAPACK_LIBS) $(BLAS_LIBS) $(HDF5_LIBS)
all: all-am
